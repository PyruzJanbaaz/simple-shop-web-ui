...
public class ApplicationMessages {
    private static ApplicationMessages instance = new ApplicationMessages();
    ...
    public String getProperty(String key) {
        try {
            if (LocaleContextHolder.getLocale().getLanguage().equals("fa")) prop = "messages_fa.properties";
            else prop = "messages.properties";
